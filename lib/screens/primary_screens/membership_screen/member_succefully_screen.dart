...
class MemberSuccefullyScreen extends StatelessWidget {
  const MemberSuccefullyScreen({Key? key}) : super(key: key);
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'يتم الآن مراجعة طلب الاشتراك وسيتم تحديث بيانات حسابك بعد المراجعة شكراً لكم',
                      style: TextStyle(
                        fontFamily: 'JF Flat',
                        fontSize: 18,
