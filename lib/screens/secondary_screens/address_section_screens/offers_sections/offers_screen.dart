...
import 'package:taif/backEndPe/all_Bloc/blocs/offers_bloc.dart';
...
class _OffersScreenState extends State<OffersScreen> {
  ...
  Widget no2(){
    return BlocProvider(
      create: (context)=>OffersBloc(OffersRepostoryImpl())..add(getOffersEventEvent()),
      child: BlocConsumer<OffersBloc, OffersState>(
        ...
        builder: (context, state) {
          ...
          }else if(state is offersStateLoaded){
            return SingleChildScrollView(
              physics: BouncingScrollPhysics(),
              child: SizedBox(
                width: ScreenUtil().screenWidth,
                child: Column(
                  ...
                  children: [
                    ...
                    if(!showMap)
                      ListView.builder(
                          itemCount: state.dataOffersModel.data!.length,
                          shrinkWrap: true,
                          physics: NeverScrollableScrollPhysics(),
                          itemBuilder: (context, index) {
                            return Container(
                              ...
                              child: offerListViewItem(
                                  ...
                                  offerModel: state.dataOffersModel,
                                  index: state.dataOffersModel.data!.length-index-1,
                                  function: () {
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                        builder: (context) =>
                                            OfferDetailsScreen(
                                              data: state.dataOffersModel.data![state.dataOffersModel.data!.length-index-1],
                                            ),
                                      ),
                                    );
                                  }),
                                ...
                                GestureDetector(
                                  onTap: (){
                                    Navigator.push(
                                      ...
                                      MaterialPageRoute(
                                        builder: (context) =>
                                            OfferDetailsScreen(
                                              data: state.dataOffersModel.data![selected],
                                            ),
                                      ),
                                    );
                                  },
                                  child: Container(
                                    ...
                                    child: Row(
                                      ...
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      children: [
                                        if(state.dataOffersModel.data![selected].image !=null)
                                          Container(
                                            height: 130.h,
                                            width: 130.h,
                                            decoration: BoxDecoration(
                                                ...
                                                image: DecorationImage(
                                                    image:NetworkImage(
                                                        'https://taif-app.com/storage/app/'+
                                                            state.dataOffersModel.data![selected].image!
                                                    ) ,
                                                    fit: BoxFit.fill
                                                )
                                            ),
                                              ...
                                              children: [
                                                Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    Expanded(
                                                      child: Text(
                                                        state.dataOffersModel.data![selected].title!,
                                                        style: TextStyle(
                                                          fontFamily: 'JF Flat',
                                                          fontSize: 14.sp,
                                                          color: const Color(0xff003e4f),
                                                    ...
                                                    children: [
                                                      Row(
                                                        ...
                                                        children: [
                                                          ...
                                                          Expanded(
                                                            child: Text(
                                                              state.dataOffersModel.data![selected].content.toString(),
                                                              style: TextStyle(
                                                                fontFamily: 'JF Flat',
                                                                fontSize: 14.sp,
                                                                color: const Color(0xff4CBB17),
